...
Vue.prototype.commonEndColumns = function (param = {}) {
  ...
  return [
    ...
    {
      title: 'Data attribution department',
      key: 'dept_belong_id',
      ...
      dict: {
        ...
        url: deptPrefix,
        isTree: true,
        value: 'id', //The attribute name of the value field in the data dictionary
        label: 'name', // The attribute name of the label field in the data dictionary
        children: 'children', // The attribute name of the children field in the data dictionary
        getData: (url, dict, {
          _,
          component
        }) => {
      ...
      form: {
        ...
        helper: {
          render (h) {
            return (< el-alert title="If not filled by default, it is the department that currently creates the userID" type="info" />
            )
          }
        }
      }
    ...
    },
    {
      ...
      search: {
        ...
        width: 240,
        component: { // Query box component configuration, generated by default based on form configuration
          name: 'el-date-picker',
          props: {
            type: 'daterange',
            'range-separator': 'to',
